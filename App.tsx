    ...
    <div className="flex min-h-screen flex-col bg-background font-funky">
      ...
      <section className="relative flex h-screen flex-col items-center justify-center overflow-hidden">
        <div className="absolute inset-0 z-0">
          <img
            src="https://placehold.co/1920x1080/png?text=Himalayan+Mountains"
        ...
        >
          ...
          <motion.p
            className="mb-8 max-w-2xl text-lg font-medium text-white sm:text-xl"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
      ...
      <section className="py-16 md:py-24">
        ...
        <motion.div
          className="relative mx-auto max-w-5xl overflow-hidden rounded-2xl border-4 border-dashed border-funky-blue bg-white p-2 shadow-xl"
          initial={{ opacity: 0 }}
        ...
        >
          <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
            <div className="relative overflow-hidden rounded-xl bg-gray-100 p-6">
              <div className="absolute -right-4 top-4 rotate-12 rounded-full bg-funky-red px-4 py-2 text-sm font-bold text-white shadow-md">
                CITY LIFE
              </div>
              <div className="relative h-[250px] overflow-hidden rounded-lg">
                <img
                  src="https://placehold.co/500x500/png?text=City+Chaos"
            ...
            <div className="relative overflow-hidden rounded-xl bg-funky-blue/10 p-6">
              <div className="absolute -right-4 top-4 rotate-12 rounded-full bg-funky-green px-4 py-2 text-sm font-bold text-white shadow-md">
                MOUNTAIN LIFE
              </div>
              <div className="relative h-[250px] overflow-hidden rounded-lg">
                <img
                  src="https://placehold.co/500x500/png?text=Himalayan+Freedom"
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-4">
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <Card className="group overflow-hidden border-2 border-funky-yellow bg-white transition-all duration-300 hover:scale-105 hover:shadow-xl">
            ...
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <Card className="group overflow-hidden border-2 border-funky-green bg-white transition-all duration-300 hover:scale-105 hover:shadow-xl">
                <CardContent className="flex flex-col items-center p-6 text-center">
            ...
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <Card className="group overflow-hidden border-2 border-funky-orange bg-white transition-all duration-300 hover:scale-105 hover:shadow-xl">
                <CardContent className="flex flex-col items-center p-6 text-center">
            ...
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <Card className="group overflow-hidden border-2 border-funky-red bg-white transition-all duration-300 hover:scale-105 hover:shadow-xl">
                <CardContent className="flex flex-col items-center p-6 text-center">
      ...
      <section className="py-16 md:py-24">
        <div className="container mx-auto px-4">
          ...
          <Tabs defaultValue="all" className="w-full">
            <TabsList className="mb-8 grid w-full max-w-md mx-auto grid-cols-4 rounded-full border-2 border-funky-blue p-1">
              <TabsTrigger
                value="all"
            ...
            <TabsContent value="all" className="mt-0">
              <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
                <StayCard
                  ...
                  rating={4.9}
                  reviews={28}
                  imageSrc="https://placehold.co/600x400/png?text=Mountain+View"
                  trending={true}
                  wifiSpeed="50 Mbps"
                />
                <StayCard
                  ...
                  rating={4.7}
                  reviews={42}
                  imageSrc="https://placehold.co/600x400/png?text=Riverside+Retreat"
                  wifiSpeed="35 Mbps"
                />
                <StayCard
                  ...
                  rating={4.8}
                  reviews={35}
                  imageSrc="https://placehold.co/600x400/png?text=Forest+Hideaway"
                  trending={true}
                  wifiSpeed="45 Mbps"
                />
              </div>
            ...
            <TabsContent value="manali" className="mt-0">
              <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
                ...
                <StayCard
                  ...
                  rating={4.8}
                  reviews={19}
                  imageSrc="https://placehold.co/600x400/png?text=Alpine+Lodge"
                  wifiSpeed="40 Mbps"
                />
              </div>
            </TabsContent>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
            <TestimonialCard
              ...
              avatarSrc="https://placehold.co/100x100/png?text=RM"
              reactions={["🔥", "💯", "👏"]}
            ...
            <TestimonialCard
              ...
              avatarSrc="https://placehold.co/100x100/png?text=SJ"
              reactions={["❤️", "😍", "🙌"]}
            ...
            <TestimonialCard
              ...
              name="Priya Sharma"
              title="UX Designer"
              avatarSrc="https://placehold.co/100x100/png?text=PS"
              reactions={["🚀", "✨", "🏔️"]}
          ...
          <div className="mt-16">
            ...
            <div className="grid grid-cols-2 gap-4 sm:grid-cols-3 md:grid-cols-6">
              {[1, 2, 3, 4, 5, 6].map((item) => (
                ...
                >
                  <img
                    src={`https://placehold.co/300x300/png?text=Instagram+${item}`}
          ...
          <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 md:grid-cols-4">
            <div>
              ...
              <div className="flex space-x-4">
                <a href="#" className="rounded-full bg-funky-blue p-2 text-white hover:bg-funky-blue/80">
                  <Instagram className="h-5 w-5" />
                  <span className="sr-only">Instagram</span>
                </a>
                <a href="#" className="rounded-full bg-funky-green p-2 text-white hover:bg-funky-green/80">
                  <Facebook className="h-5 w-5" />
                  <span className="sr-only">Facebook</span>
                </a>
                <a href="#" className="rounded-full bg-funky-yellow p-2 text-black hover:bg-funky-yellow/80">
                  <Twitter className="h-5 w-5" />
                  <span className="sr-only">Twitter</span>
                </a>
                <a href="#" className="rounded-full bg-funky-red p-2 text-white hover:bg-funky-red/80">
            ...
            <div>
              ...
              <ul className="space-y-3 text-sm">
                <li>
                  <a href="#" className="flex items-center text-muted-foreground hover:text-funky-blue">
                    <span className="mr-2 text-lg">✨</span> About Us
                  </a>
                </li>
                <li>
                  <a href="#" className="flex items-center text-muted-foreground hover:text-funky-green">
                    <span className="mr-2 text-lg">🏔️</span> Destinations
                  </a>
                </li>
                <li>
                  <a href="#" className="flex items-center text-muted-foreground hover:text-funky-yellow">
                    <span className="mr-2 text-lg">📝</span> Blog
                  </a>
                </li>
                <li>
                  <a href="#" className="flex items-center text-muted-foreground hover:text-funky-red">
